...
public class Tablero {	
	...
	/**
	 * Muestra el contenido del tablero en modo solo horizontal.
	 */
	public void mostrarTableroVertical() {
		System.out.println();
		System.out.print("");
		for(int j=0; j<this.getNumColumnas(); j++) {
			System.out.print("|"+(j+1) + "|");
 ...
 */
	...
	/**
	 * Permite introducir por teclado las coordenadas de la casilla vertical
	 * que elegirá el usuario
	 * Se actualizará el atributo columna del objeto con la elección
	 */
		public void leeMovimientoVertical() {
			Scanner sc = new Scanner(System.in);
			int b;
			boolean salir = false;
			while(!salir) {
...
/**
* Permite introducir por teclado las coordenadas de la casilla horizontal
* que elegirá el usuario
* Se actualizarán el atributo filadel objeto con la elección
*/	
	public void leeMovimientoHorizontal() {
		Scanner sc = new Scanner(System.in);
		int a;
		boolean salir = false;
		while(!salir) {
